package com.mingri.train12306.framework.starter.idempotent.config;

import com.mingri.train12306.framework.starter.cache.DistributedCache;
import com.mingri.train12306.framework.starter.idempotent.core.IdempotentAspect;
import com.mingri.train12306.framework.starter.idempotent.core.param.IdempotentParamExecuteHandler;
import com.mingri.train12306.framework.starter.idempotent.core.param.IdempotentParamService;
import com.mingri.train12306.framework.starter.idempotent.core.spel.IdempotentSpELByMQExecuteHandler;
import com.mingri.train12306.framework.starter.idempotent.core.spel.IdempotentSpELByRestAPIExecuteHandler;
import com.mingri.train12306.framework.starter.idempotent.core.spel.IdempotentSpELService;
import com.mingri.train12306.framework.starter.idempotent.core.token.IdempotentTokenController;
import com.mingri.train12306.framework.starter.idempotent.core.token.IdempotentTokenExecuteHandler;
import com.mingri.train12306.framework.starter.idempotent.core.token.IdempotentTokenService;
