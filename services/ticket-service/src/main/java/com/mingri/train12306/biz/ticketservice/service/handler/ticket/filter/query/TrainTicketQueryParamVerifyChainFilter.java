package com.mingri.train12306.biz.ticketservice.service.handler.ticket.filter.query;
...
import com.mingri.train12306.biz.ticketservice.dao.entity.RegionDO;
import com.mingri.train12306.biz.ticketservice.dao.entity.StationDO;
import com.mingri.train12306.biz.ticketservice.dao.mapper.RegionMapper;
import com.mingri.train12306.biz.ticketservice.dao.mapper.StationMapper;
...
import static com.mingri.train12306.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_QUERY_ALL_REGION_LIST;
import static com.mingri.train12306.biz.ticketservice.common.constant.RedisKeyConstant.QUERY_ALL_REGION_LIST;
...
public class TrainTicketQueryParamVerifyChainFilter implements TrainTicketQueryChainFilter<TicketPageQueryReqDTO> {
    ...
    public void handler(TicketPageQueryReqDTO requestParam) {
        ...
        List<Object> actualExistList = hashOperations.multiGet(// multiGet 方法用于根据给定的键列表，批量获取对应的值。
        ...
        // FLAG = true 代表已经加载过一次，若此时还是空的，证明说数据库也没有这两个站点信息，抛异常
        ...
        try {
            ...
            emptyCount = regionValueMap.keySet().stream()
                    //方法检查each.toString()的值是否与requestParam.getFromStation()和requestParam.getToStation()中的任意一个相等
